...
function sayHello(){
    ...
    let age = 21; //variable number
    let birthday = true; //variable boolean
    ...
    console.log("Sum of x and y is -->", diff);
    console.log("Sum of x and y is -->", product);
    console.log("Sum of x and y is -->", quotient);
    console.log("Sum of x and y is -->", modulo);

    //console.log(typeof(sample)) //input in sample the type of variable or string
}
sayHello();
...
function LogicalExpressions(){
    ...
    // AND operator will only show true if all/or both side is true
    console,log("Sunny && Warm", sunny && warm);

    // OR operator will only show true if either one is true
    console,log("Sunny || Warm", sunny || warm);
